...
function appendFilter() {
  ...
  #filter {
    ...
    background: linear-gradient(
      ...
      rgba(255, 255, 255, 0.225) calc(25% + 1px),
      rgba(255, 255, 255, 0.225) calc(50%),
      rgba(255, 255, 255, 0.7) calc(50% + 1px),
      rgba(255, 255, 255, 0.15) calc(50% + 1px),
      rgba(255, 255, 255, 0.15) calc(75%),
      rgba(255, 255, 255, 0.7) calc(75% + 1px),
      rgba(255, 255, 255, 0.1) calc(75% + 1px),
      rgba(255, 255, 255, 0.1) calc(100%)
    )
  }
  `;
